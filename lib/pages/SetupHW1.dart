...
class SetupHW1 extends StatelessWidget {
  @override
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            Text(
                              "Data from hardware sensors (moisture, humidity, temperature, and water) will help you take good care of your plant and monitor their health, so let's see the steps needed.",
                              style: TextStyle(
                                color: Color(0xFF7FBC69),
                                fontSize: 18,
                              ),
                            ...
                            Center(
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.push(context, SlidePageRoute(page: SetupHW2()));
                                },
                                child: Container(
                                  padding: EdgeInsets.all(10),
                                  decoration: BoxDecoration(
