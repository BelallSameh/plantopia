...
class SetupHW3 extends StatelessWidget {
  @override
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 10),
                            Text(
                              "Put the humidity and temperature sensors away from any water nor dirt but still close to the plant.",
                              style: TextStyle(
                                color: Color(0xFF7FBC69),
                                fontSize: 18,
                              ),
                            ...
                            Center(
                              child: GestureDetector(
                                onTap: () {
                                  Navigator.push(context, SlidePageRoute(page: SetupHW4()));
                                },
                                child: Container(
                                  padding: EdgeInsets.all(10),
                                  decoration: BoxDecoration(
